...
import NEsysml.Aadl.Implementation;
 ...
 * </p>
 * <ul>
 *   <li>{@link NEsysml.Aadl.impl.ImplementationImpl#getBase_Generalization <em>Base Generalization</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationImpl extends MinimalEObjectImpl.Container implements Implementation {
	...
	protected EClass eStaticClass() {
		return AadlPackage.Literals.IMPLEMENTATION;
	}
		...
		if (base_Generalization != null && base_Generalization.eIsProxy()) {
			...
			if (base_Generalization != oldBase_Generalization) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AadlPackage.IMPLEMENTATION__BASE_GENERALIZATION, oldBase_Generalization, base_Generalization));
			}
		}
	...
	public void setBase_Generalization(Generalization newBase_Generalization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlPackage.IMPLEMENTATION__BASE_GENERALIZATION, oldBase_Generalization, base_Generalization));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AadlPackage.IMPLEMENTATION__BASE_GENERALIZATION:
