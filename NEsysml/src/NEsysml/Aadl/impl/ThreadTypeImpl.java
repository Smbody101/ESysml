...
import NEsysml.Aadl.ThreadType;
 ...
 * </p>
 * <ul>
 *   <li>{@link NEsysml.Aadl.impl.ThreadTypeImpl#getOwnedErrorModel <em>Owned Error Model</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ThreadTypeImpl#getExtended <em>Extended</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ThreadTypeImpl#getOwnedAnnex <em>Owned Annex</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ThreadTypeImpl#getOwnedDataAccess <em>Owned Data Access</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ThreadTypeImpl#getOwnedport <em>Ownedport</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ThreadTypeImpl#getOwnedSubprogramAccess <em>Owned Subprogram Access</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ThreadTypeImpl#getOwnedMode <em>Owned Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThreadTypeImpl extends BlockImpl implements ThreadType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return AadlPackage.Literals.THREAD_TYPE;
	}
	...
	public ComponentType basicGetExtended() {
		...
		for(Generalization g : generalizations)
			if(AadlUtil.eINSTANCE.isStereotypedBy(g, AadlPackage.Literals.EXTENSION))
				return (ComponentType) AadlUtil.eINSTANCE.getStereotypeApplication(g.getGeneral(), AadlPackage.Literals.THREAD_TYPE);
		return null;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AadlPackage.THREAD_TYPE__OWNED_ERROR_MODEL:
				if (resolve) return getOwnedErrorModel();
				return basicGetOwnedErrorModel();
			case AadlPackage.THREAD_TYPE__EXTENDED:
				if (resolve) return getExtended();
				return basicGetExtended();
			case AadlPackage.THREAD_TYPE__OWNED_ANNEX:
				return getOwnedAnnex();
			case AadlPackage.THREAD_TYPE__OWNED_DATA_ACCESS:
				return getOwnedDataAccess();
			case AadlPackage.THREAD_TYPE__OWNEDPORT:
				return getOwnedport();
			case AadlPackage.THREAD_TYPE__OWNED_SUBPROGRAM_ACCESS:
				return getOwnedSubprogramAccess();
			case AadlPackage.THREAD_TYPE__OWNED_MODE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ComponentClassifier.class) {
			switch (derivedFeatureID) {
				case AadlPackage.THREAD_TYPE__OWNED_ERROR_MODEL: return AadlPackage.COMPONENT_CLASSIFIER__OWNED_ERROR_MODEL;
				default: return -1;
			}
		}
		if (baseClass == ComponentType.class) {
			switch (derivedFeatureID) {
				case AadlPackage.THREAD_TYPE__EXTENDED: return AadlPackage.COMPONENT_TYPE__EXTENDED;
				default: return -1;
			}
		}
		if (baseClass == AnnexContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.THREAD_TYPE__OWNED_ANNEX: return AadlPackage.ANNEX_CONTAINING__OWNED_ANNEX;
				default: return -1;
			}
		}
		if (baseClass == DataAccessContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.THREAD_TYPE__OWNED_DATA_ACCESS: return AadlPackage.DATA_ACCESS_CONTAINING__OWNED_DATA_ACCESS;
				default: return -1;
			}
		}
		if (baseClass == PortContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.THREAD_TYPE__OWNEDPORT: return AadlPackage.PORT_CONTAINING__OWNEDPORT;
				default: return -1;
			}
		}
		if (baseClass == SubprogramAccessContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.THREAD_TYPE__OWNED_SUBPROGRAM_ACCESS: return AadlPackage.SUBPROGRAM_ACCESS_CONTAINING__OWNED_SUBPROGRAM_ACCESS;
				default: return -1;
			}
		}
		if (baseClass == ModeAvailable.class) {
			switch (derivedFeatureID) {
				case AadlPackage.THREAD_TYPE__OWNED_MODE: return AadlPackage.MODE_AVAILABLE__OWNED_MODE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ComponentClassifier.class) {
			switch (baseFeatureID) {
				case AadlPackage.COMPONENT_CLASSIFIER__OWNED_ERROR_MODEL: return AadlPackage.THREAD_TYPE__OWNED_ERROR_MODEL;
				default: return -1;
			}
		}
		if (baseClass == ComponentType.class) {
			switch (baseFeatureID) {
				case AadlPackage.COMPONENT_TYPE__EXTENDED: return AadlPackage.THREAD_TYPE__EXTENDED;
				default: return -1;
			}
		}
		if (baseClass == AnnexContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.ANNEX_CONTAINING__OWNED_ANNEX: return AadlPackage.THREAD_TYPE__OWNED_ANNEX;
				default: return -1;
			}
		}
		if (baseClass == DataAccessContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.DATA_ACCESS_CONTAINING__OWNED_DATA_ACCESS: return AadlPackage.THREAD_TYPE__OWNED_DATA_ACCESS;
				default: return -1;
			}
		}
		if (baseClass == PortContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.PORT_CONTAINING__OWNEDPORT: return AadlPackage.THREAD_TYPE__OWNEDPORT;
				default: return -1;
			}
		}
		if (baseClass == SubprogramAccessContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.SUBPROGRAM_ACCESS_CONTAINING__OWNED_SUBPROGRAM_ACCESS: return AadlPackage.THREAD_TYPE__OWNED_SUBPROGRAM_ACCESS;
				default: return -1;
			}
		}
		if (baseClass == ModeAvailable.class) {
			switch (baseFeatureID) {
				case AadlPackage.MODE_AVAILABLE__OWNED_MODE: return AadlPackage.THREAD_TYPE__OWNED_MODE;
				default: return -1;
			}
		}
		if (baseClass == SoftwareClassifier.class) {
