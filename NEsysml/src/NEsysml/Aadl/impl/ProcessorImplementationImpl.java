...
import NEsysml.Aadl.ProcessorImplementation;
 ...
 * </p>
 * <ul>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#isEncapsulated <em>Is Encapsulated</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#getOwnedAnnex <em>Owned Annex</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#getOwnedBusConnection <em>Owned Bus Connection</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#getOwnedBusSubcomponent <em>Owned Bus Subcomponent</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#getOwnedMemorySubcomponent <em>Owned Memory Subcomponent</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#getOwnedPortConnection <em>Owned Port Connection</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#getOwnedMode <em>Owned Mode</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorImplementationImpl#getOwnedSubprogramAccessConnection <em>Owned Subprogram Access Connection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessorImplementationImpl extends ComponentImplementationImpl implements ProcessorImplementation {
	...
	protected EClass eStaticClass() {
		return AadlPackage.Literals.PROCESSOR_IMPLEMENTATION;
	}
		...
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AadlPackage.PROCESSOR_IMPLEMENTATION__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public void setBase_Class(org.eclipse.uml2.uml.Class newBase_Class) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlPackage.PROCESSOR_IMPLEMENTATION__BASE_CLASS, oldBase_Class, base_Class));
	}
	...
	public void setIsEncapsulated(boolean newIsEncapsulated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AadlPackage.PROCESSOR_IMPLEMENTATION__IS_ENCAPSULATED, oldIsEncapsulated, isEncapsulated));
	}
	...
	public ComponentType basicGetType() {
		...
		for(Generalization generalization : this.getBase_Class().getGeneralizations()) {
			if(AadlUtil.eINSTANCE.isStereotypedBy(generalization, AadlPackage.Literals.IMPLEMENTATION)) {
				if(AadlUtil.eINSTANCE.isStereotypedBy(generalization.getGeneral(), AadlPackage.Literals.PROCESSOR_TYPE))
					return (ComponentType) AadlUtil.eINSTANCE.getStereotypeApplication(generalization.getGeneral(), AadlPackage.Literals.PROCESSOR_TYPE);
			}
		}
		return null;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AadlPackage.PROCESSOR_IMPLEMENTATION__BASE_CLASS:
				if (resolve) return getBase_Class();
				return basicGetBase_Class();
			case AadlPackage.PROCESSOR_IMPLEMENTATION__IS_ENCAPSULATED:
				return isEncapsulated();
			case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_ANNEX:
				return getOwnedAnnex();
			case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_BUS_CONNECTION:
				return getOwnedBusConnection();
			case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_BUS_SUBCOMPONENT:
				return getOwnedBusSubcomponent();
			case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_MEMORY_SUBCOMPONENT:
				return getOwnedMemorySubcomponent();
			case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_PORT_CONNECTION:
				return getOwnedPortConnection();
			case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_MODE:
				if (resolve) return getOwnedMode();
				return basicGetOwnedMode();
			case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_SUBPROGRAM_ACCESS_CONNECTION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Block.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_IMPLEMENTATION__BASE_CLASS: return BlocksPackage.BLOCK__BASE_CLASS;
				case AadlPackage.PROCESSOR_IMPLEMENTATION__IS_ENCAPSULATED: return BlocksPackage.BLOCK__IS_ENCAPSULATED;
				default: return -1;
			}
		}
		if (baseClass == AnnexContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_ANNEX: return AadlPackage.ANNEX_CONTAINING__OWNED_ANNEX;
				default: return -1;
			}
		}
		if (baseClass == BusAccessConnectionContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_BUS_CONNECTION: return AadlPackage.BUS_ACCESS_CONNECTION_CONTAINING__OWNED_BUS_CONNECTION;
				default: return -1;
			}
		}
		if (baseClass == BusContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_BUS_SUBCOMPONENT: return AadlPackage.BUS_CONTAINING__OWNED_BUS_SUBCOMPONENT;
				default: return -1;
			}
		}
		if (baseClass == MemoryContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_MEMORY_SUBCOMPONENT: return AadlPackage.MEMORY_CONTAINING__OWNED_MEMORY_SUBCOMPONENT;
				default: return -1;
			}
		}
		if (baseClass == PortConnectionContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_PORT_CONNECTION: return AadlPackage.PORT_CONNECTION_CONTAINING__OWNED_PORT_CONNECTION;
				default: return -1;
			}
		}
		if (baseClass == ModeAvailable.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_MODE: return AadlPackage.MODE_AVAILABLE__OWNED_MODE;
				default: return -1;
			}
		}
		...
		if (baseClass == SubprogramAccessConnectionContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_SUBPROGRAM_ACCESS_CONNECTION: return AadlPackage.SUBPROGRAM_ACCESS_CONNECTION_CONTAINING__OWNED_SUBPROGRAM_ACCESS_CONNECTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Block.class) {
			switch (baseFeatureID) {
				case BlocksPackage.BLOCK__BASE_CLASS: return AadlPackage.PROCESSOR_IMPLEMENTATION__BASE_CLASS;
				case BlocksPackage.BLOCK__IS_ENCAPSULATED: return AadlPackage.PROCESSOR_IMPLEMENTATION__IS_ENCAPSULATED;
				default: return -1;
			}
		}
		if (baseClass == AnnexContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.ANNEX_CONTAINING__OWNED_ANNEX: return AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_ANNEX;
				default: return -1;
			}
		}
		if (baseClass == BusAccessConnectionContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.BUS_ACCESS_CONNECTION_CONTAINING__OWNED_BUS_CONNECTION: return AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_BUS_CONNECTION;
				default: return -1;
			}
		}
		if (baseClass == BusContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.BUS_CONTAINING__OWNED_BUS_SUBCOMPONENT: return AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_BUS_SUBCOMPONENT;
				default: return -1;
			}
		}
		if (baseClass == MemoryContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.MEMORY_CONTAINING__OWNED_MEMORY_SUBCOMPONENT: return AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_MEMORY_SUBCOMPONENT;
				default: return -1;
			}
		}
		if (baseClass == PortConnectionContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.PORT_CONNECTION_CONTAINING__OWNED_PORT_CONNECTION: return AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_PORT_CONNECTION;
				default: return -1;
			}
		}
		if (baseClass == ModeAvailable.class) {
			switch (baseFeatureID) {
				case AadlPackage.MODE_AVAILABLE__OWNED_MODE: return AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_MODE;
				default: return -1;
			}
		}
		if (baseClass == PlatformClassifier.class) {
		...
		if (baseClass == SubprogramAccessConnectionContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.SUBPROGRAM_ACCESS_CONNECTION_CONTAINING__OWNED_SUBPROGRAM_ACCESS_CONNECTION: return AadlPackage.PROCESSOR_IMPLEMENTATION__OWNED_SUBPROGRAM_ACCESS_CONNECTION;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Block.class) {
			switch (baseOperationID) {
				case BlocksPackage.BLOCK___GET_REFERENCES: return AadlPackage.PROCESSOR_IMPLEMENTATION___GET_REFERENCES;
				case BlocksPackage.BLOCK___GET_PARTS: return AadlPackage.PROCESSOR_IMPLEMENTATION___GET_PARTS;
				case BlocksPackage.BLOCK___GET_FLOW_PROPERTIES: return AadlPackage.PROCESSOR_IMPLEMENTATION___GET_FLOW_PROPERTIES;
				default: return -1;
			}
		}
		if (baseClass == AnnexContaining.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AadlPackage.PROCESSOR_IMPLEMENTATION___GET_REFERENCES:
				return getReferences();
			case AadlPackage.PROCESSOR_IMPLEMENTATION___GET_PARTS:
				return getParts();
			case AadlPackage.PROCESSOR_IMPLEMENTATION___GET_FLOW_PROPERTIES:
