...
public class Main extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/AadlGen/main/main";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateAADL" };
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(org.eclipse.emf.ecore.EcorePackage.class)) {
            ...
            resourceSet.getPackageRegistry().put(Aadl2Package.eNS_URI, Aadl2Package.eINSTANCE);
            resourceSet.getPackageRegistry().put(AadlBaPackage.eNS_URI, AadlBaPackage.eINSTANCE);
            resourceSet.getPackageRegistry().put(ErrorModelPackage.eNS_URI, ErrorModelPackage.eINSTANCE);
        }
