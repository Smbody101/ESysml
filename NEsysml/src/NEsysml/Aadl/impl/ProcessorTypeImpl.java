...
import NEsysml.Aadl.ProcessorType;
 ...
 * </p>
 * <ul>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorTypeImpl#getOwnedErrorModel <em>Owned Error Model</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorTypeImpl#getExtended <em>Extended</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorTypeImpl#getOwnedAnnex <em>Owned Annex</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorTypeImpl#getOwnedBusAccess <em>Owned Bus Access</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorTypeImpl#getOwnedport <em>Ownedport</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorTypeImpl#getOwnedMode <em>Owned Mode</em>}</li>
 *   <li>{@link NEsysml.Aadl.impl.ProcessorTypeImpl#getOwnedSubprogramAccess <em>Owned Subprogram Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessorTypeImpl extends BlockImpl implements ProcessorType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return AadlPackage.Literals.PROCESSOR_TYPE;
	}
	...
	public ComponentType basicGetExtended() {
		...
		for(Generalization g : generalizations)
			if(AadlUtil.eINSTANCE.isStereotypedBy(g, AadlPackage.Literals.EXTENSION))
				return (ComponentType) AadlUtil.eINSTANCE.getStereotypeApplication(g.getGeneral(), AadlPackage.Literals.PROCESSOR_TYPE);
		return null;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AadlPackage.PROCESSOR_TYPE__OWNED_ERROR_MODEL:
				if (resolve) return getOwnedErrorModel();
				return basicGetOwnedErrorModel();
			case AadlPackage.PROCESSOR_TYPE__EXTENDED:
				if (resolve) return getExtended();
				return basicGetExtended();
			case AadlPackage.PROCESSOR_TYPE__OWNED_ANNEX:
				return getOwnedAnnex();
			case AadlPackage.PROCESSOR_TYPE__OWNED_BUS_ACCESS:
				return getOwnedBusAccess();
			case AadlPackage.PROCESSOR_TYPE__OWNEDPORT:
				return getOwnedport();
			case AadlPackage.PROCESSOR_TYPE__OWNED_MODE:
				if (resolve) return getOwnedMode();
				return basicGetOwnedMode();
			case AadlPackage.PROCESSOR_TYPE__OWNED_SUBPROGRAM_ACCESS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ComponentClassifier.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_TYPE__OWNED_ERROR_MODEL: return AadlPackage.COMPONENT_CLASSIFIER__OWNED_ERROR_MODEL;
				default: return -1;
			}
		}
		if (baseClass == ComponentType.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_TYPE__EXTENDED: return AadlPackage.COMPONENT_TYPE__EXTENDED;
				default: return -1;
			}
		}
		if (baseClass == AnnexContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_TYPE__OWNED_ANNEX: return AadlPackage.ANNEX_CONTAINING__OWNED_ANNEX;
				default: return -1;
			}
		}
		if (baseClass == BusAccessContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_TYPE__OWNED_BUS_ACCESS: return AadlPackage.BUS_ACCESS_CONTAINING__OWNED_BUS_ACCESS;
				default: return -1;
			}
		}
		if (baseClass == PortContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_TYPE__OWNEDPORT: return AadlPackage.PORT_CONTAINING__OWNEDPORT;
				default: return -1;
			}
		}
		if (baseClass == ModeAvailable.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_TYPE__OWNED_MODE: return AadlPackage.MODE_AVAILABLE__OWNED_MODE;
				default: return -1;
			}
		}
		...
		if (baseClass == SubprogramAccessContaining.class) {
			switch (derivedFeatureID) {
				case AadlPackage.PROCESSOR_TYPE__OWNED_SUBPROGRAM_ACCESS: return AadlPackage.SUBPROGRAM_ACCESS_CONTAINING__OWNED_SUBPROGRAM_ACCESS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ComponentClassifier.class) {
			switch (baseFeatureID) {
				case AadlPackage.COMPONENT_CLASSIFIER__OWNED_ERROR_MODEL: return AadlPackage.PROCESSOR_TYPE__OWNED_ERROR_MODEL;
				default: return -1;
			}
		}
		if (baseClass == ComponentType.class) {
			switch (baseFeatureID) {
				case AadlPackage.COMPONENT_TYPE__EXTENDED: return AadlPackage.PROCESSOR_TYPE__EXTENDED;
				default: return -1;
			}
		}
		if (baseClass == AnnexContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.ANNEX_CONTAINING__OWNED_ANNEX: return AadlPackage.PROCESSOR_TYPE__OWNED_ANNEX;
				default: return -1;
			}
		}
		if (baseClass == BusAccessContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.BUS_ACCESS_CONTAINING__OWNED_BUS_ACCESS: return AadlPackage.PROCESSOR_TYPE__OWNED_BUS_ACCESS;
				default: return -1;
			}
		}
		if (baseClass == PortContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.PORT_CONTAINING__OWNEDPORT: return AadlPackage.PROCESSOR_TYPE__OWNEDPORT;
				default: return -1;
			}
		}
		if (baseClass == ModeAvailable.class) {
			switch (baseFeatureID) {
				case AadlPackage.MODE_AVAILABLE__OWNED_MODE: return AadlPackage.PROCESSOR_TYPE__OWNED_MODE;
				default: return -1;
			}
		}
		if (baseClass == PlatformClassifier.class) {
		...
		if (baseClass == SubprogramAccessContaining.class) {
			switch (baseFeatureID) {
				case AadlPackage.SUBPROGRAM_ACCESS_CONTAINING__OWNED_SUBPROGRAM_ACCESS: return AadlPackage.PROCESSOR_TYPE__OWNED_SUBPROGRAM_ACCESS;
				default: return -1;
			}
		}
